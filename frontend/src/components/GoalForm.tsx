...
import type { Goal, GoalCreate, GoalUpdate, GoalStatus, Team, Category } from '../types';

interface GoalFormProps {
  goal?: Goal | null;
  onSubmit: (goalData: GoalCreate | GoalUpdate) => void;
  onCancel?: () => void;
  teams?: Team[];
  categories?: Category[];
}
...
export default function GoalForm({ goal, onSubmit, onCancel, teams = [], categories = [] }: GoalFormProps) {
