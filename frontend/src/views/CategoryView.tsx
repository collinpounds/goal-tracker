...
import type { RootState, AppDispatch, Goal } from '../types';
...
const CategoryView = () => {
  ...
  const { categories, categoryGoals, loading } = useSelector((state: RootState) => state.categories);
  ...
  const handleDeleteCategory = async () => {
    if (category && window.confirm(`Are you sure you want to delete "${category.name}"? This action cannot be undone.`)) {
