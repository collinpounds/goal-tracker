...
from .routers import goals, health, teams, categories, statuses, files
...
This API uses Supabase (PostgreSQL) for data persistence. All timestamps are stored in UTC with timezone information.
    ...
    openapi_tags=[
        ...
        {
            "name": "categories",
            "description": "Operations for managing categories. Categories help organize goals with custom labels, colors, and icons.",
        },
        {
            "name": "teams",
        ...
        {
            "name": "statuses",
            "description": "Operations for managing custom statuses. Users and teams can define custom status values beyond the defaults.",
        },
        {
            "name": "files",
            "description": "Operations for managing goal file attachments. Upload, download, and delete files associated with goals.",
        },
        {
            "name": "health",
